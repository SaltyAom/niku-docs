...
Note: Using `.asNiku()` won't import property from a widget, instead it will return a new instance of predefined Widget and import only required property instead.
